...
describe('drop-erc-test', function () {
                ...
                [
                    ...
                    utils.keccak256(
                        utils.defaultAbiCoder.encode(
                            ...
                            [CLAIM_TYPEHASH, erc.address, owner, spender, value, deadline]
                        )
                    )
                ]
            )
    ...
    async function print() {
        ...
        let amount = d(await bank.tokenUserBalance(erc.address, accounts[0].address))
	    console.log('account0  erc in bank:', amount)
        amount = d(await bank.tokenUserBalance(erc.address, accounts[1].address))
	    console.log('account1  erc in bank:', amount)
