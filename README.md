...
#### NTF是身份的象征，类似勋章，空投活动仅需要组合各类NFT便得到用户画像，避免重复筛选用户。随着越来越多的NFT铸造出来，用户画像越来越准确，Token能够更精确空投给目标人群，NFT就越有价值。
<br>

### 为什么要用离线签名？有什么优势和劣势？
#### 离线签名可以免gas费，且处理速度很快。如果空投给10万用户，不用离线签名的话，gas费是一笔不小的费用，且10万个交易上链也要花费很长时间。劣势的话大概是技术会比较复杂，不过我们已经解决了。
<br>
...
### NFT可以交易吗？
#### 目前没有交易所能交易，用户只能自己私下交易。下一步将对接NFT交易所，或者我们再开发一个NFT交易所。
<br>

### DeDrops开发了多久？未来有什么计划？
#### 2021年7月29号开始开发，之前做了一些框架和开发环境的准备，为了参加Layer2黑客松，7月31号第一个版本上线到Polygon。未来将部署到ETH、BSC、HECO等各个EVM链上，用NFT的创意和免gas费及去中心化的优势，让更多的项目方使用DeDrops，使DeDrops成为用户流量入口。
<br>

### 有没有发币或融资计划？
#### 发币计划暂时没有，DeDrops的愿景首先是成为用户流量入口，再考虑发币。接受投资，具体面谈。
